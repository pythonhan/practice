...
#     基本统计
    ...
    # top10
    top10_cities = aqi_data.sort_values(by= ['AQI']).head(10)   #升序排列
    # aqi_date.sort_values(by = ['AQI'], ascending= False).tail(10)  #降序排列
    print('空气质量最好的10个城市：')
    print(top10_cities)

    #bottom10
    bottom10_cities = aqi_data.sort_values(by= ['AQI']).tail(10)   #升序排列
    # aqi_date.sort_values(by = ['AQI'], ascending= False).head(10)  #降序排列
    print('空气质量最差的10个城市：')
